...
export default function App() {
  ...
  const handleAddCustomProfile = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!newUserName.trim() || creatingProfile) return;
            ...
            <form onSubmit={handleAddCustomProfile} className="space-y-3 text-xs">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-2 bg-sky-600 hover:bg-sky-500 text-white font-medium rounded-xl transition shadow-md shadow-sky-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
                >
